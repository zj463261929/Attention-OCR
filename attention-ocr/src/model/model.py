...
class Model(object):
    ...
    def launch(self):
        ...
        #加载字典
        trieTree.trie = trieTree.construction_trietree("/opt/datasets/data/str/mnt/ramdisk/max/90kDICT32px/lexicon.txt") #("userdic.txt")
        ...
        if self.phase == 'test':
            ...
            for batch in self.s_gen.gen(self.batch_size):
                ...
                logging.info('%f out of %d correct, precision=%.4f' %(num_correct, num_total, num_correct/(1+num_total)))
